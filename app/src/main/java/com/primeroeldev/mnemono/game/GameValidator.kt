...
val validators: Map<String, Array<Pair<String, ((Any) -> Boolean)>>> = mapOf(
    ...
    "correctAnswersCount" to arrayOf(
        Pair("game_validation_correctAnswersCount_min", { v: Any -> min(0L)(v as Long) }),
        Pair("game_validation_correctAnswersCount_max", { v: Any -> max(99999999999L)(v as Long) }),
    ),
    "allAnswersCount" to arrayOf(
        Pair("game_validation_allAnswersCount_min", { v: Any -> min(0L)(v as Long) }),
        Pair("game_validation_allAnswersCount_max", { v: Any -> max(99999999999L)(v as Long) }),
    ),
    "type" to arrayOf(
